...
function initSearch() {
  ...
  request.open('GET', '/Unified-Substrate-Theory/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/Unified-Substrate-Theory/assets/css/just-the-docs-' + theme + '.css');
}
